<?php
$app->post ( "/getNotesByBook", function () use($app) {
...
$sql = $conn->prepare("SELECT `BOOKTIPID`, `PAGENOFROM`, `PAGENOTO`, `BOOKTIPREF`, `BOOKTIPTITLE`, `BOOKTIP`, `USERNAME`, `USERID`, `BOOKID`, `TIME`, `BOOKNAME`,
 `SUBNAME`, `SUBID`, `SEM`, `EDITTIME` FROM `BOOKTIP` where bookname LIKE CONCAT('%', :bookname, '%')) ORDER BY `TIME` DESC LIMIT :PAGENO , :RESULTS_PER_PAGE ");
